	...
	<template v-if="store.client && store.auth.token">
		...
		<div
			...
			<div
				...
				<div
					class="flex overflow-x-hidden flex-col gap-y-4 px-4 md:py-4 h-full w-full no-scroll overflow-x-hidden md:col-span-5 col-span-6 md:border-x border-gray-300 dark:border-dark-700 dark:bg-dark-800">
					<slot />
				</div>
				<div
					v-if="width >= 1280"
