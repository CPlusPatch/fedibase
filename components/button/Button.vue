...
<template>
	<button
		:class="[
			'inline-flex justify-center relative ease-in-out items-center no-bad-scale px-4 py-2 text-base font-medium rounded-md border shadow duration-200 focus:outline-none sm:text-sm',
			theme && themes[theme],
