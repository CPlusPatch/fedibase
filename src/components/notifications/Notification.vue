...
<template>
	<li v-if="['favourite', 'reblog', 'emoji_reaction', 'mention'].includes(props.notification.type)" :class="['flex flex-col gap-y-2 p-2 max-w-full hover:scale-[98%] rounded duration-200 ease-in-out',
		...
		<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
			class="text-blue-500 hover:animate-spin w-[1em] inline pb-0.5 mr-1" viewBox="0 0 576 512">
